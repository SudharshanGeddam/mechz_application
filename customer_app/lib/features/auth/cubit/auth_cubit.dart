...
class AuthCubit  extends Cubit<AuthState>{
  ...
  void sendOtp(String phoneNumber) async {
    ...
    await _authRepository.verifyPhone(phoneNumber: phoneNumber, codeSent: (verificationId) {
  ...
  Future<void> verifyOtp(
    ...
    try {
      ...
      await _authRepository.verifyOtp(verificationId: verificationId, smsCode: smsCode);
